...
<head>
    ...
    <title>Peta Titik Kebencanaan</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top" style="background-color: #C58940;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="fa-solid fa-map-location-dot"></i>Peta Titik Persebaran Bencana</a>
    ...
    <div class="container">
        <div class="card my-3">
            <div class="card-header text-center">
                <h2> <b> Input Data Titik Kebencanaan</b></h2>
            </div>
            <div class="card-body">
    ...
    <script>
        var center = [-7.422327190013333, 109.57721968819394];
