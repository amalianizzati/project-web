...
<body>
    ...
    <div class="modal fade" id="polylineModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="fas fa-edit"></i> Edit Polyline</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('leafletdraw/simpan_edit_data_polyline') ?>" method="POST">
                        ...
                        <input type="hidden" name="id_polyline" id="id_polyline">

                        <label for="edit_polyline_name">Nama</label>
                        <input type="text" class="form-control" name="edit_polyline_name" id="edit_polyline_name">

                        <label for="edit_polyline_deskripsi">Deskripsi</label>
                        <input type="text" class="form-control" name="edit_polyline_deskripsi" id="edit_polyline_deskripsi">
    ...
    <script>
            ...
            onEachFeature: function(feature, layer) {
                ...
                layer.on({
                    click: function(e) {
                        ...
                        $('#edit_polyline_name').val(feature.properties.nama);
        ...
        map.on(L.Draw.Event.EDITED, function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                var confirm = window.confirm("Apakah Anda yakin akan mengubah polyline ini?");
                if (confirm) {
